export declare type I2CBufferSource = ArrayBuffer | ArrayBufferView | SharedArrayBuffer;
export declare type I2CReadResult = {
    bytesRead: number;
    buffer: ArrayBuffer;
};
export declare type I2CWriteResult = {
    bytesWritten: number;
    buffer: ArrayBuffer;
};
export declare type I2CAddress = number;
