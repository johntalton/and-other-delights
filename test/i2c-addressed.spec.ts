...
describe('I2CAddressedBus', () => {
  ...
  describe('#name', () => {
    it('should support oo construction', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, SCRIPT);
  ...
  describe('#close', () => {
    it('should close gracefully', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, CLOSE_SCRIPT);
      const ab = new I2CAddressedBus(sb, SCRIPT_BUS_ADDRESS);
  ...
  describe('#read', () => {
    it('should read bytes', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, READ_SCRIPT);
      const ab = new I2CAddressedBus(sb, SCRIPT_BUS_ADDRESS);
  ...
  describe('#write', () => {
    it('should write bytes', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, WRITE_SCRIPT);
      const ab = new I2CAddressedBus(sb, SCRIPT_BUS_ADDRESS);
  ...
  describe('#writeSpecial', () => {
    it('should', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, SPECIAL_SCRIPT);
      const ab = new I2CAddressedBus(sb, SCRIPT_BUS_ADDRESS);
  ...
  describe('#readBuffer', () => {
    it('should', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, BUFFER_READ_SCRIPT);
  ...
  describe('#writeBuffer', () => {
    it('should', async () => {
      const sb = await I2CScriptBus.openPromisified(SCRIPT_BUS_NUMBER, BUFFER_WRITE_SCRIPT);
      const ab = new I2CAddressedBus(sb, 0x00);
